 ...
 * <p>
 * You can use guardman-generator as an annotation processor to generate bean
 * meta classes. Then you can use meta classes to validate Java beans.
 * <p>
 ...
 *     );
 *     c.property(cm.startDate).required().lt(cm.endDate, "End Date");
